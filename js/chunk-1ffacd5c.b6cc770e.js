(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
    ["chunk-1ffacd5c"], {
        "14c3": function(e, t, o) {
            var n = o("c6b6"),
                l = o("9263");
            e.exports = function(e, t) { var o = e.exec; if ("function" === typeof o) { var i = o.call(e, t); if ("object" !== typeof i) throw TypeError("RegExp exec method returned something other than an Object or null"); return i } if ("RegExp" !== n(e)) throw TypeError("RegExp#exec called on incompatible receiver"); return l.call(e, t) }
        },
        "25f0": function(e, t, o) {
            "use strict";
            var n = o("6eeb"),
                ...
                s = RegExp.prototype,
                c = s[r],
                u = i((function() { return "/a/b" != c.call({ source: "a", flags: "b" }) })),
                f = c.name != r;
        ...
        "4de4": function(e, t, o) {
            ...
            var n = o("23e7"),
                ...
                r = i("filter"),
                s = a("filter");
            n({ target: "Array", proto: !0, forced: !r || !s }, { filter: function(e) { return l(this, e, arguments.length > 1 ? arguments[1] : void 0) } })
        },
        5319: function(e, t, o) {
            "use strict";
            var n = o("d784"),
                ...
                d = /\$([$&'`]|\d\d?|<[^>]*>)/g,
                h = /\$([$&'`]|\d\d?)/g,
                b = function(e) { return void 0 === e ? e : String(e) };
            n("replace", 2, (function(e, t, o, n) {
                ...
                return [function(o, n) {
                    ...
                    if (!S && g || "string" === typeof n && -1 === n.indexOf(v)) { var i = o(t, e, this, n); if (i.done) return i.value }
                    var s = l(e),
                        m = String(this),
                        d = "function" === typeof n;
                    d || (n = String(n));
                    ...
                    var _ = [];
                    while (1) { var x = u(s, m); if (null === x) break; if (_.push(x), !h) break; var A = String(x[0]); "" === A && (s.lastIndex = c(m, a(s.lastIndex), R)) }
                    ...
                    return void 0 !== a && (a = i(a), u = d), t.call(r, u, (function(t, i) {
                        ...
                        switch (i.charAt(0)) {
                            ...
                            default:
                                var u = +i;
                                if (0 === u) return t;
                                if (u > c) { var f = m(u / 10); return 0 === f ? t : f <= c ? void 0 === l[f - 1] ? i.charAt(1) : l[f - 1] + i.charAt(1) : t }
                                r = l[u - 1]
                        }
                        return void 0 === r ? "" : r
                    }))
        ...
        "8aa5": function(e, t, o) {
            "use strict";
            var n = o("6547").charAt;
            e.exports = function(e, t, o) { return t + (o ? n(e, t).length : 1) }
        },
        9263: function(e, t, o) {
            "use strict";
            var n = o("ad6d"),
            ...
            f && (r = function(e) {
                var t, o, l, r, f = this,
                    ...
                    h = 0,
                    b = e;
                return p && (m = m.replace("y", ""), -1 === m.indexOf("g") && (m += "g"), b = String(e).slice(f.lastIndex), f.lastIndex > 0 && (!f.multiline || f.multiline && "\n" !== e[f.lastIndex - 1]) && (d = "(?: " + d + ")", b = " " + b, h++), o = new RegExp("^(?:" + d + ")", m)), u && (o = new RegExp("^" + d + "$(?!\\s)", m)), s && (t = f.lastIndex), l = i.call(p ? o : f, b), p ? l ? (l.input = l.input.slice(h), l[0] = l[0].slice(h), l.index = f.lastIndex, f.lastIndex += l[0].length) : f.lastIndex = 0 : s && l && (f.lastIndex = f.global ? l.index + l[0].length : t), u && l && l.length > 1 && a.call(l[0], o, (function() { for (r = 1; r < arguments.length - 2; r++) void 0 === arguments[r] && (l[r] = void 0) })), l
            }), e.exports = r
        },
        "9f7f": function(e, t, o) {
            "use strict";
            ...
            function l(e, t) { return RegExp(e, t) }
            t.UNSUPPORTED_Y = n((function() { var e = l("a", "y"); return e.lastIndex = 2, null != e.exec("abcd") })), t.BROKEN_CARET = n((function() { var e = l("^r", "gy"); return e.lastIndex = 2, null != e.exec("str") }))
        },
        a640: function(e, t, o) {
            "use strict";
            var n = o("d039");
            ...
            var n = function() {
                ...
                m = {
                    ...
                    methods: {
                        ...
                        gotoTgChannel: function() { window.open(p) },
                        gotoGayhub: function() { window.open(r) },
                        gotoRemoteConfig: function() { window.open(a) },
                        ...
                        makeUrl: function() {
                            ...
                            if (n = n.replace(/(\n|\r|\n\r)/g, "|"), -1 !== n.indexOf("losadhwse") && (-1 !== t.indexOf("py6.pw") || -1 !== t.indexOf("subconverter-web.now.sh") || -1 !== t.indexOf("subconverter.herokuapp.com") || -1 !== t.indexOf("api.wcc.best"))) return this.$alert("此机场订阅已将该后端屏蔽，请自建后端转换。", "转换错误提示", { confirmButtonText: "确定", callback: function(t) { e.$message({ type: "error", message: "action: ".concat(t) }) } }), !1;
                        ...
                        createFilter: function(e) { return function(t) { return 0 === t.value.toLowerCase().indexOf(e.toLowerCase()) } },
                        getBackendVersion: function() {
                            var e = this;
                            this.$axios.get(s.substring(0, s.length - 5) + "/version").then((function(t) { e.backendVersion = t.data.replace(/backend\n$/gm, ""), e.backendVersion = e.backendVersion.replace("subconverter", "") }))
                        },
                        saveSubUrl: function() { "" !== this.form.sourceSubUrl && this.setLocalStorageItem("sourceSubUrl", this.form.sourceSubUrl) },
                        ...
                        setLocalStorageItem: function(e, t) {
                            var o = "86400",
                                n = +new Date,
                                l = { setTime: n, ttl: parseInt(o), expire: n + 1e3 * o, value: t };
        ...
        ac1f: function(e, t, o) {
            ...
            var n = o("23e7"),
                l = o("9263");
            n({ target: "RegExp", proto: !0, forced: /./.exec !== l }, { exec: l })
        },
        ad6d: function(e, t, o) {
            "use strict";
            var n = o("825a");
        ...
        b64b: function(e, t, o) {
            var n = o("23e7"),
                ...
                a = o("d039"),
                r = a((function() { i(1) }));
            n({ target: "Object", stat: !0, forced: r }, { keys: function(e) { return i(l(e)) } })
        },
        c975: function(e, t, o) {
            "use strict";
            var n = o("23e7"),
            ...
            n({ target: "Array", proto: !0, forced: s || !c || !u }, { indexOf: function(e) { return s ? r.apply(this, arguments) || 0 : l(this, e, arguments.length > 1 ? arguments[1] : void 0) } })
        },
        d784: function(e, t, o) {
            "use strict";
            o("ac1f");
            var n = o("6eeb"),
                ...
                r = o("9112"),
                s = i("species"),
                c = !l((function() { var e = /./; return e.exec = function() { var e = []; return e.groups = { a: "7" }, e }, "7" !== "".replace(e, "$<a>") })),
                u = function() { return "$0" === "a".replace(/./, "$0") }(),
                f = i("replace"),
                p = function() { return !!/./ [f] && "" === /./ [f]("a", "$0") }(),
                m = !l((function() {
                    var e = /(?:)/,
                        t = e.exec;
            ...
            e.exports = function(e, t, o, f) {
                var d = i(e),
                    h = !l((function() { var t = {}; return t[d] = function() { return 7 }, 7 != "" [e](t) })),
                    b = h && !l((function() {
                        var t = !1,
                            o = /a/;
                        return "split" === e && (o = {}, o.constructor = {}, o.constructor[s] = function() { return o }, o.flags = "", o[d] = /./ [d]), o.exec = function() { return t = !0, null }, o[d](""), !t
                    }));
                if (!h || !b || "replace" === e && (!c || !u || p) || "split" === e && !m) {
                    var S = /./ [d],
                        g = o(d, "" [e], (function(e, t, o, n, l) { return t.exec === a ? h && !l ? { done: !0, value: S.call(t, o, n) } : { done: !0, value: e.call(o, t, n) } : { done: !1 } }), { REPLACE_KEEPS_$0: u, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: p }),
                        v = g[0],
                        C = g[1];
                    n(String.prototype, e, v), n(RegExp.prototype, d, 2 == t ? function(e, t) { return C.call(e, this, t) } : function(e) { return C.call(e, this) })
                }
